...
async function getEnergyConsumed(startDate: string, endDate: string) {
  ...
  const res = await fetch(
    `https://gonansen.com.br/endpoints/central-monitoring/energy-consumed/?start_date=${formatDate(
      startDate,
...
export default function EnergiaConsumidaPorPeriodo() {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "EnergiaConsumida");
    XLSX.writeFile(wb, "energia-consumida.xlsx");
  };
