...
async function getStayDuration(startDate: string, endDate: string) {
  ...
  const res = await fetch(
    `https://gonansen.com.br/endpoints/central-monitoring/failures/?start_date=${formatDate(
      startDate,
...
export default function FalhasCarregadores() {
  const [data, setData] = useState<DuracaoItem | null>(null);
